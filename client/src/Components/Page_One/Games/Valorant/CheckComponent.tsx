...
export function CheckComponent() {
  ...
  const API = [
    ...
    { id: 3, name: 'Cermonies', link: 'ValorantCermonies', conponent: <ValorantCermonies /> },
    { id: 4, name: 'Competitive_Tiers', link: 'ValorantCompetitive_Tiers', conponent: <ValorantCompetitive_Tiers /> },
    { id: 5, name: 'Cuntent_Tiers', link: 'ValorantCuntent_Tiers', conponent: <ValorantCuntent_Tiers /> },
    { id: 6, name: 'Contracts', link: 'ValorantContracts', conponent: <ValorantContracts />   },
    { id: 7, name: 'Currencies', link: 'ValorantCurrencies', conponent: <ValorantCurrencies /> },
    { id: 8, name: 'Events', link: 'ValorantEvents', conponent: <ValorantEvents /> },
    {
      id: 9,
      name: 'Gamemodes',
    ...
    { id: 11, name: 'Level_Borders', link: 'ValorantLevel_Borders', conponent: <ValorantLevel_Borders /> },
    { id: 12, name: 'Maps', link: 'ValorantMaps', conponent: <ValorantMaps /> },
    { id: 13, name: 'Player_Cards', link: 'ValorantPlayer_Cards', conponent: <ValorantPlayer_Cards /> },
    { id: 14, name: 'Players_Titles', link: 'ValorantPlayers_Titles', conponent: <ValorantPlayers_Titles /> },
    { id: 15, name: 'Seasons', link: 'ValorantSeasons', conponent: <ValorantSeasons /> },
    { id: 16, name: 'Sprays', link: 'ValorantSprays', conponent: <ValorantSprays /> },
    { id: 17, name: 'Themes', link: 'ValorantThemes', conponent: <ValorantThemes /> },
    { id: 18, name: 'Weapons', link: 'ValorantWeapons', conponent: <ValorantWeapons /> },
    { id: 19, name: 'Version', link: 'ValorantVersion', conponent: <ValorantVersion /> },
  ];
